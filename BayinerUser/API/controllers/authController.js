                          ...
                          <tr>
                              <td style="text-align:center;">
                                <a href="https://www.okkalikahve.com.tr" title="logo" target="_blank">
                                  <img width="240" src="https://www.okkalikahve.com.tr/wp-content/uploads/2020/06/cropped-Okkalı-1.png" title="logo" alt="logo">
                                </a>
                              </td>
                          </tr>
                          <tr>
                                  ...
                                  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                      ...
                                      <tr>
                                          <td style="padding:0 35px;">
                                              <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Şifre değiştirme talebinizi aldık</h1>
                                              <span
                                                  style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                              <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                  Sizin için yeni bir şifre oluşturduk. Lütfen şifrenizi başkalarıyla paylaşmayınız. Şifrenizi, sizin için oluşturduğumuz bu şifre ile giriş yaptıktan
